...
public class IncentivesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utils.setActionBarScreen("Incentive", getSupportActionBar());
        ...
        sessionManager = new SessionManager(IncentivesActivity.this);
        linearLayoutManager = new LinearLayoutManager(getApplicationContext(), RecyclerView.VERTICAL, false);
        rvMyTransactions.setLayoutManager(linearLayoutManager);
        incentivesAdapter = new IncentivesAdapter(this, list);
        rvMyTransactions.setAdapter(incentivesAdapter);
        rvMyTransactions.setNestedScrollingEnabled(false);
        getIncentiveAPI(true);
    ...
    private void showAlert(String message) {
        new AlertDialog.Builder(IncentivesActivity.this)
                .setMessage(message)
                .setTitle("Alert!")
    ...
    private void getIncentiveAPI(boolean isFirstTimeCall) {
        if (isFirstTimeCall) {
        ...
        Velocity.get(UtilityConstraints.UrlLocation.INCENTIVE_LIST)
                ...
                .connect(new Velocity.ResponseListener() {
                        ...
                        try {
                            ...
                            if (!mainObject.getBoolean("error")) {
                                ...
                                for (int i = 0; i < data.length(); i++) {
                                    ...
                                    list.add(new IncentivesModel(
                                            object.getString("id"),
                                            object.getString("lead_receipt_no"),
                                            object.getString("lead"),
                                            object.getString("created_at"),
                                            object.getString("incentive_amount")));
                                }
                    ...
                    public void onVelocityFailed(Velocity.Response error) {
                        ...
                        try {
                            ...
                            Toast.makeText(IncentivesActivity.this, mainObject.getString("message"), Toast.LENGTH_SHORT).show();
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                    }
