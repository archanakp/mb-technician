...
public class EditOdometerActivity extends AppCompatActivity {
    Menu menu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utils.setActionBarScreen("Edit Odometer", getSupportActionBar());
        loader = findViewById(R.id.loader);
        Velocity.initialize(3);
        currentReading = findViewById(R.id.current_reading);
        currentReading.setText(getIntent().getStringExtra("current_reading"));
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.menu_item_tick) {
            if (Utils.isNetworkConnected(EditOdometerActivity.this)) {
    ...
    private void updateImageAPI() {
        Velocity.post(UtilityConstraints.UrlLocation.EDIT_ODOMETER)
