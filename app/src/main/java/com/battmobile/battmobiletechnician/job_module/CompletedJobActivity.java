...
public class CompletedJobActivity extends AppCompatActivity {
    ...
    String TAG = CompletedJobActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sessionManager = new SessionManager(CompletedJobActivity.this);
        ...
        jobAdapter.setOnItemClickListener(new JobAdapter.MyClickListener() {
            ...
            public void onItemClick(int position, View v) {
                startActivityForResult(new Intent(CompletedJobActivity.this, JobDetailActivity.class)
    ...
    private void showAlert(String message) {
        new AlertDialog.Builder(CompletedJobActivity.this)
                .setMessage(message)
                .setTitle("Alert!")
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.menu_item_add) {
            if (Utils.isNetworkConnected(CompletedJobActivity.this)) {
                startActivityForResult(new Intent(CompletedJobActivity.this, RescheduleActivity.class)
                ...
                .connect(new Velocity.ResponseListener() {
                    ...
                    public void onVelocityFailed(Velocity.Response error) {
                        ...
                        try {
                            ...
                            Toast.makeText(CompletedJobActivity.this, mainObject.getString("message"), Toast.LENGTH_SHORT).show();
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                    }
